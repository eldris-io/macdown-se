...
static NSString * const kMPApplicationName = @"MacDown SE";

static NSString * const kMPApplicationBundleIdentifier = @"io.eldris.macdown-se";
static NSString * const kMPApplicationSuiteName = @"io.eldris.macdown-se";
